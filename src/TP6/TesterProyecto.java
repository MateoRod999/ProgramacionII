...
public class TesterProyecto extends ProyectoColaborativo{
    public TesterProyecto(String empResponsable) {
    ...
    public void inicioTarea() {
        if (estado==false){
            ...
            progresoTareas.add("El tester comenzo su trabajo a las horas: "+horaInicio+" Fecha: "+fechaInicio);
        }
        else{
    ...
    public void finTarea() {
        if(estado==true){
            ...
            progresoTareas.add("El tester finalizo su trabajo a las horas: "+horaFin+" Fecha: "+fechaFin);
        }
        else{
    ...
    public String progresoActual() {
        return "Estado Tester: "+ (estado ? "En progreso..." : "No hay ninguna tarea en progreso.");
    }
    ...
    public void calcularTiempo() {
        if (horaInicio != null && horaFin != null) {
            ...
            System.out.println("Tiempo total invertido por el tester en la tarea: " + horas + " horas, " + minutos + " minutos y " + segundos + " segundos.");
        } else {
